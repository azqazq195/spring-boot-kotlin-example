...
interface ICRUDController<E, CD, UD> where E : PrimaryKeyEntity, E : IEntity, CD : ICreateDto<E>, UD : IUpdateDto<E> {
    ...
    fun createAll(@RequestBody createDtoList: List<CD>): ResponseDto<Any>
    fun update(@PathVariable id: Long, @RequestBody updateDto: UD): ResponseDto<Any>
    fun updateAll(@RequestBody updateDtoList: List<UD>): ResponseDto<Any>
